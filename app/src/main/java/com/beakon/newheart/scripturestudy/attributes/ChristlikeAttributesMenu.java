...
@ActivityScope
public class ChristlikeAttributesMenu extends BaseMenu {

    @NonNull
    private final ChristlikeAttributesScreen screen;

    @NonNull
    private final ChristlikeAttributesController controller;

    @Inject
    public ChristlikeAttributesMenu(@NonNull BaseActivity activity,
                                    @NonNull ChristlikeAttributesScreen screen,
                                    @NonNull ChristlikeAttributesController controller) {
        super(activity);
        this.screen = screen;
