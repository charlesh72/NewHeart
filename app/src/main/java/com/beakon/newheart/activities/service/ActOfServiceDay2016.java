...
public class ActOfServiceDay2016 extends RealmObject implements ActOfServiceDay {

    @Ignore
    public static int LIGHT_TITLES_ID = R.array.light_the_world_titles_2016;
    @Ignore
    public static int LIGHT_ACTS_ID = R.array.light_the_world_acts_2016;
    ...
    private static List<ActOfServiceDay2016> createActsList() {
    ...
    public static List<ActOfServiceDay> getActsList() {
        Realm realm = Realm.getDefaultInstance();
        RealmResults<ActOfServiceDay2016> results = realm.where(ActOfServiceDay2016.class).findAll().sort("day");
        List<ActOfServiceDay> list = new ArrayList<>(25);
        if (results.size() != 25) {
            createActsList();
            results = realm.where(ActOfServiceDay2016.class).findAll().sort("day");
        }
